...
var (
	...
	DEF_URLS_MARKET_STATUS_URL = "https://pay.destinia.ir/includes/curl.php?u=aHR0cDovL3d3dy50c2V0bWMuY29tL0xvYWRlci5hc3B4P1BhclRyZWU9MTUNCg==&gzdecode=1"
	//DEF_URLS_PRICE_URL               = "http://www.tsetmc.com/tsev2/data/MarketWatchPlus.aspx?h=0&r=2222"
	DEF_URLS_PRICE_URL = "https://pay.destinia.ir/includes/curl.php?u=aHR0cDovL3d3dy50c2V0bWMuY29tL3RzZXYyL2RhdGEvTWFya2V0V2F0Y2hQbHVzLmFzcHg/aD0wJnI9MjIyMg==&gzdecode=1"
	//DEF_URLS_IO_URL                  = "http://www.tsetmc.com/tsev2/data/ClientTypeAll.aspx"
	DEF_URLS_IO_URL = "https://pay.destinia.ir/includes/curl.php?u=aHR0cDovL3d3dy50c2V0bWMuY29tL3RzZXYyL2RhdGEvQ2xpZW50VHlwZUFsbC5hc3B4&gzdecode=1"
	//DEF_URLS_PERIODIC_AVERAGES_URL   = "http://tsetmc.com/tsev2/data/InstValue.aspx?t=a"
	DEF_URLS_PERIODIC_AVERAGES_URL  = "https://pay.destinia.ir/includes/curl.php?u=aHR0cDovL3RzZXRtYy5jb20vdHNldjIvZGF0YS9JbnN0VmFsdWUuYXNweD90PWE=&gzdecode=1"
